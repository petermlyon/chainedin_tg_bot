...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/safer-buffer/Porting-Buffer.md";
...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h1">
        <a href="#porting-to-the-buffer.frombuffer.alloc-api">Porting to the Buffer.from/Buffer.alloc API</a>
      </div>
      ...
      <div class="heading h3">
        <a href="#finding-problematic-bits-of-code-using-grep">Finding problematic bits of code using grep</a>
      </div>

      <div class="heading h3">
        <a href="#finding-problematic-bits-of-code-using-node.js-8">Finding problematic bits of code using Node.js 8</a>
      </div>

      <div class="heading h3">
        <a href="#finding-problematic-bits-of-code-using-linters">Finding problematic bits of code using linters</a>
      </div>

      <div class="heading h2">
        <a href="#variant-1-drop-support-for-node.js-4.4.x-and-5.0.0-5.9.x">Variant 1: Drop support for Node.js ≤ 4.4.x and 5.0.0 — 5.9.x.</a>
      </div>

      <div class="heading h2">
        <a href="#variant-2-use-a-polyfill">Variant 2: Use a polyfill</a>
      </div>

      <div class="heading h2">
        <a href="#variant-3-manual-detection-with-safeguards">Variant 3 — manual detection, with safeguards</a>
      </div>

      <div class="heading h3">
        <a href="#buffer-0">Buffer(0)</a>
      </div>

      <div class="heading h3">
        <a href="#buffer-notnumber">Buffer(notNumber)</a>
      </div>

      <div class="heading h3">
        <a href="#buffer-number">Buffer(number)</a>
      </div>

      <div class="heading h2">
        <a href="#regarding-buffer.allocunsafe">Regarding Buffer.allocUnsafe</a>
      </div>
      ...
      <div class="heading h3">
        <a href="#what-is-wrong-with-the-buffer-constructor">What is wrong with the Buffer constructor?</a>
      </div>

      <div class="heading h3">
        <a href="#the-buffer-constructor-has-been-deprecated-for-a-while.is-this-really-an-issue">The Buffer() constructor has been deprecated for a while. Is this really an issue?</a>
      </div>
  ...
  <div id="container">
    <div class="docs markdown"><div class="pilwrap" id="porting-to-the-buffer.frombuffer.alloc-api">
  <h1>
    <a href="#porting-to-the-buffer.frombuffer.alloc-api" name="porting-to-the-buffer.frombuffer.alloc-api" class="pilcrow"></a>
...
<ul>
<li><a href="#variant-1.html">Variant 1: Drop support for Node.js ≤ 4.4.x and 5.0.0 — 5.9.x.</a> (<em>recommended</em>)</li>
<li><a href="#variant-2.html">Variant 2: Use a polyfill</a></li>
<li><a href="#variant-3.html">Variant 3: manual detection, with safeguards</a></li>
</ul>
<div class="pilwrap" id="finding-problematic-bits-of-code-using-grep">
  <h3>
    <a href="#finding-problematic-bits-of-code-using-grep" name="finding-problematic-bits-of-code-using-grep" class="pilcrow"></a>
...
exceptions).</p>
<div class="pilwrap" id="finding-problematic-bits-of-code-using-node.js-8">
  <h3>
    <a href="#finding-problematic-bits-of-code-using-node.js-8" name="finding-problematic-bits-of-code-using-node.js-8" class="pilcrow"></a>
...
<pre><code class="console"><span class="hljs-meta">$</span><span class="bash"> <span class="hljs-built_in">export</span> NODE_OPTIONS=<span class="hljs-string">'--trace-warnings --pending-deprecation'</span></span>
...
<div class="pilwrap" id="finding-problematic-bits-of-code-using-linters">
  <h3>
    <a href="#finding-problematic-bits-of-code-using-linters" name="finding-problematic-bits-of-code-using-linters" class="pilcrow"></a>
...
<div class="pilwrap" id="variant-1-drop-support-for-node.js-4.4.x-and-5.0.0-5.9.x">
  <h2>
    <a href="#variant-1-drop-support-for-node.js-4.4.x-and-5.0.0-5.9.x" name="variant-1-drop-support-for-node.js-4.4.x-and-5.0.0-5.9.x" class="pilcrow"></a>
...
for you, or if you support older branches of your packages, consider using <a href="#variant-2.html">Variant 2</a>
or <a href="#variant-3.html">Variant 3</a> on older branches, so people using those older branches will also receive
...
<div class="pilwrap" id="variant-2-use-a-polyfill">
  <h2>
    <a href="#variant-2-use-a-polyfill" name="variant-2-use-a-polyfill" class="pilcrow"></a>
Variant 2: Use a polyfill
  </h2>
</div>
<p>Utilize <a href="https://www.npmjs.com/package/safer-buffer">safer-buffer</a> as a polyfill to support older
Node.js versions.</p>
<p>You would take exacly the same steps as in <a href="#variant-1.html">Variant 1</a>, but with a polyfill
...
<div class="pilwrap" id="variant-3-manual-detection-with-safeguards">
  <h2>
    <a href="#variant-3-manual-detection-with-safeguards" name="variant-3-manual-detection-with-safeguards" class="pilcrow"></a>
...
<div class="pilwrap" id="buffer-0">
  <h3>
    <a href="#buffer-0" name="buffer-0" class="pilcrow"></a>
Buffer(0)
  </h3>
</div>
...
<div class="pilwrap" id="buffer-notnumber">
  <h3>
    <a href="#buffer-notnumber" name="buffer-notnumber" class="pilcrow"></a>
Buffer(notNumber)
  </h3>
</div>
<p>Before:</p>
<pre><code class="js"><span class="hljs-keyword">var</span> buf = <span class="hljs-keyword">new</span> Buffer(notNumber, encoding);
</code></pre>
<p>After:</p>
<pre><code class="js"><span class="hljs-keyword">var</span> buf;
...
compiles to.</p>
<div class="pilwrap" id="buffer-number">
  <h3>
    <a href="#buffer-number" name="buffer-number" class="pilcrow"></a>
Buffer(number)
  </h3>
</div>
...
<pre><code class="js"><span class="hljs-keyword">const</span> buf = Buffer.alloc ? Buffer.alloc(number) : <span class="hljs-keyword">new</span> Buffer(number).fill(<span class="hljs-number">0</span>);
</code></pre>
<div class="pilwrap" id="regarding-buffer.allocunsafe">
  <h2>
    <a href="#regarding-buffer.allocunsafe" name="regarding-buffer.allocunsafe" class="pilcrow"></a>
...
<div class="pilwrap" id="what-is-wrong-with-the-buffer-constructor">
  <h3>
    <a href="#what-is-wrong-with-the-buffer-constructor" name="what-is-wrong-with-the-buffer-constructor" class="pilcrow"></a>
What is wrong with the <code>Buffer</code> constructor?
  </h3>
</div>
...
<div class="pilwrap" id="the-buffer-constructor-has-been-deprecated-for-a-while.is-this-really-an-issue">
  <h3>
    <a href="#the-buffer-constructor-has-been-deprecated-for-a-while.is-this-really-an-issue" name="the-buffer-constructor-has-been-deprecated-for-a-while.is-this-really-an-issue" class="pilcrow"></a>
The <code>Buffer()</code> constructor has been deprecated for a while. Is this really an issue?
  </h3>
</div>
