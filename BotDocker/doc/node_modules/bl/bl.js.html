...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/bl/bl.js";
...
<p>safeguard so that we don't return uninitialized memory</p>

        </td>
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">if</span> (dst.length &gt; bufoff) <span class="hljs-keyword">return</span> dst.slice(<span class="hljs-number">0</span>, bufoff)
...
<p>first, normalize the argument, in accordance with how Buffer does it</p>

        </td>
        <td class="code highlight">
          <pre class="javascript">  bytes = <span class="hljs-built_in">Math</span>.trunc(bytes)
</pre>
        </td>
      </tr>
...
<p>do nothing if not a positive number</p>

        </td>
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">if</span> (<span class="hljs-built_in">Number</span>.isNaN(bytes) || bytes &lt;= <span class="hljs-number">0</span>) <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>
