...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/lodash/template.js";
...
<span class="hljs-keyword">var</span> INVALID_TEMPL_VAR_ERROR_TEXT = <span class="hljs-string">'Invalid `variable` option passed into `_.template`'</span>;
...
<div class="dox">
<div class="summary">
<p>Used to validate the <code>validate</code> option in <code>_.template</code> variable.</p>
</div>
<div class="body">
<p>Forbids characters which could potentially change the meaning of the function argument definition:</p>
<ul>
<li>&quot;(),&quot; (modification of function parameters)</li>
<li>&quot;=&quot; (default value)</li>
<li>&quot;[]{}&quot; (destructuring of function parameters)</li>
<li>&quot;/&quot; (beginning of a comment)</li>
<li>whitespace</li>
</ul>
</div>
</div>
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-keyword">var</span> reForbiddenIdentifierChars = <span class="hljs-regexp">/[()=,{}\[\]\/\s]/</span>;
...
and escape the comment, thus injecting code that gets evaled.</p>
    ...
    ? (<span class="hljs-string">'//# sourceURL='</span> +
       (options.sourceURL + <span class="hljs-string">''</span>).replace(<span class="hljs-regexp">/\s/g</span>, <span class="hljs-string">' '</span>) +
...
<p>Throw an error if a forbidden character was found in <code>variable</code>, to prevent
potential command injection attacks.</p>

        </td>
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (reForbiddenIdentifierChars.test(variable)) {
    <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> <span class="hljs-built_in">Error</span>(INVALID_TEMPL_VAR_ERROR_TEXT);
  }
