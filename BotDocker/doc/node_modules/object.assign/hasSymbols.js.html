...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/object.assign/hasSymbols.js";
...
<div class="body">
	...
	obj[sym] = symVal;
	<span class="hljs-keyword">for</span> (sym <span class="hljs-keyword">in</span> obj) { <span class="hljs-keyword">return</span> <span class="hljs-literal">false</span>; } <span class="hljs-comment">// eslint-disable-line no-unreachable-loop</span>
	<span class="hljs-keyword">if</span> (keys(obj).length !== <span class="hljs-number">0</span>) { <span class="hljs-keyword">return</span> <span class="hljs-literal">false</span>; }
