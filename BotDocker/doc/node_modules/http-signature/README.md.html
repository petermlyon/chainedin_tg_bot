...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/http-signature/README.md";
...
httpSignature.sign(req, {
  ...
  <span class="hljs-attr">keyPassphrase</span>: <span class="hljs-string">'secret'</span> <span class="hljs-comment">// (optional)</span>
});
