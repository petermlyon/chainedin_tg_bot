...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/has-symbols/shams.js";
...
<span class="hljs-comment">/* eslint complexity: [2, 18], max-statements: [2, 33] */</span>
...
if (String(sym) !== Symbol.prototype.toString.call(sym)) { return false; }</p>
	...
	obj[sym] = symVal;
	<span class="hljs-keyword">for</span> (sym <span class="hljs-keyword">in</span> obj) { <span class="hljs-keyword">return</span> <span class="hljs-literal">false</span>; } <span class="hljs-comment">// eslint-disable-line no-restricted-syntax, no-unreachable-loop</span>
