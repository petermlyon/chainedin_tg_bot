...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/jsbn/index.js";
...
<p>Pick bases at random, instead of starting at 2</p>
        ...
        <span class="hljs-keyword">if</span>(y.compareTo(BigInteger.ONE) != <span class="hljs-number">0</span> &amp;&amp; y.compareTo(n1) != <span class="hljs-number">0</span>) {
          ...
          <span class="hljs-keyword">while</span>(j++ &lt; k &amp;&amp; y.compareTo(n1) != <span class="hljs-number">0</span>) {
            y = y.modPowInt(<span class="hljs-number">2</span>,<span class="hljs-keyword">this</span>);
            <span class="hljs-keyword">if</span>(y.compareTo(BigInteger.ONE) == <span class="hljs-number">0</span>) <span class="hljs-keyword">return</span> <span class="hljs-literal">false</span>;
          }
          <span class="hljs-keyword">if</span>(y.compareTo(n1) != <span class="hljs-number">0</span>) <span class="hljs-keyword">return</span> <span class="hljs-literal">false</span>;
        }
      }
