...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/eventemitter3/index.js";
...
<div class="dox">
<div class="summary">
<p>Constructor to create a storage for our <code>EE</code> objects.
An <code>Events</code> instance is a plain object whose properties are event names.</p>
</div>
<div class="body">
</div>
<div class="details">
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">Events</span>(<span class="hljs-params"></span>) </span>{}
...
<p>We try to not inherit from <code>Object.prototype</code>. In some engines creating an
instance in this way is faster than calling <code>Object.create(null)</code> directly.
If <code>Object.create(null)</code> is not supported we prefix the event names with a
character to make sure that the built-in object properties are not
overridden or used as an attack vector.</p>

        </td>
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-keyword">if</span> (<span class="hljs-built_in">Object</span>.create) {
  Events.prototype = <span class="hljs-built_in">Object</span>.create(<span class="hljs-literal">null</span>);
...
<p>This hack is needed because the <code>__proto__</code> property is still inherited in
some old browsers like Android 4, iPhone 5.1, Opera 11 and Safari 5.</p>

        </td>
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">if</span> (!<span class="hljs-keyword">new</span> Events().__proto__) prefix = <span class="hljs-literal">false</span>;
}
...
<div class="dox">
<div class="summary">
<p>Representation of a single event listener.</p>
</div>
<div class="body">
</div>
<div class="details">
...
<span>The listener function.
</span>
</div>
<div class="dox_tag_detail">
<span class="dox_tag_name">context</span>
<span>The context to invoke the listener with.
</span>
</div>
<div class="dox_tag_detail">
<span class="dox_tag_name">[once=false]</span>
<span class="dox_type">Boolean</span>
<span>Specify if the listener is a one-time listener.
</span>
</div>
</div>
</div>
...
<span>Reference to the <code>EventEmitter</code> instance.
</span>
</div>
<div class="dox_tag_detail">
<span class="dox_tag_name">event</span>
<span class="dox_type">String</span>
<span class="dox_type">Symbol</span>
<span>The event name.
</span>
</div>
<div class="dox_tag_detail">
...
<span>Specify if the listener is a one-time listener.
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">addListener</span>(<span class="hljs-params">emitter, event, fn, context, once</span>) </span>{
  <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> fn !== <span class="hljs-string">'function'</span>) {
    <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> <span class="hljs-built_in">TypeError</span>(<span class="hljs-string">'The listener must be a function'</span>);
  }

  <span class="hljs-keyword">var</span> listener = <span class="hljs-keyword">new</span> EE(fn, context || emitter, once)
    , evt = prefix ? prefix + event : event;

  <span class="hljs-keyword">if</span> (!emitter._events[evt]) emitter._events[evt] = listener, emitter._eventsCount++;
  <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (!emitter._events[evt].fn) emitter._events[evt].push(listener);
  <span class="hljs-keyword">else</span> emitter._events[evt] = [emitter._events[evt], listener];
...
<span>The Event name.
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">clearEvent</span>(<span class="hljs-params">emitter, evt</span>) </span>{
  <span class="hljs-keyword">if</span> (--emitter._eventsCount === <span class="hljs-number">0</span>) emitter._events = <span class="hljs-keyword">new</span> Events();
  <span class="hljs-keyword">else</span> <span class="hljs-keyword">delete</span> emitter._events[evt];
}
...
<div class="dox">
<div class="summary">
<p>Minimal <code>EventEmitter</code> interface that is molded against the Node.js
...
<div class="details">
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">EventEmitter</span>(<span class="hljs-params"></span>) </span>{
  <span class="hljs-keyword">this</span>._events = <span class="hljs-keyword">new</span> Events();
...
<div class="details">
  ...
  <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>._eventsCount === <span class="hljs-number">0</span>) <span class="hljs-keyword">return</span> names;

  <span class="hljs-keyword">for</span> (name <span class="hljs-keyword">in</span> (events = <span class="hljs-keyword">this</span>._events)) {
...
<span>The event name.
        ...
        <td class="code highlight">
          <pre class="javascript">EventEmitter.prototype.listeners = <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">listeners</span>(<span class="hljs-params">event</span>) </span>{
  <span class="hljs-keyword">var</span> evt = prefix ? prefix + event : event
    , handlers = <span class="hljs-keyword">this</span>._events[evt];

  <span class="hljs-keyword">if</span> (!handlers) <span class="hljs-keyword">return</span> [];
  <span class="hljs-keyword">if</span> (handlers.fn) <span class="hljs-keyword">return</span> [handlers.fn];

  <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>, l = handlers.length, ee = <span class="hljs-keyword">new</span> <span class="hljs-built_in">Array</span>(l); i &lt; l; i++) {
    ee[i] = handlers[i].fn;
  }
...
<span>The event name.
        ...
        <td class="code highlight">
          <pre class="javascript">EventEmitter.prototype.listenerCount = <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">listenerCount</span>(<span class="hljs-params">event</span>) </span>{
  <span class="hljs-keyword">var</span> evt = prefix ? prefix + event : event
    , listeners = <span class="hljs-keyword">this</span>._events[evt];

  <span class="hljs-keyword">if</span> (!listeners) <span class="hljs-keyword">return</span> <span class="hljs-number">0</span>;
  <span class="hljs-keyword">if</span> (listeners.fn) <span class="hljs-keyword">return</span> <span class="hljs-number">1</span>;
  <span class="hljs-keyword">return</span> listeners.length;
};
...
<span>The event name.
  ...
  <span class="hljs-keyword">if</span> (!<span class="hljs-keyword">this</span>._events[evt]) <span class="hljs-keyword">return</span> <span class="hljs-literal">false</span>;
  ...
  <span class="hljs-keyword">if</span> (listeners.fn) {
    ...
    <span class="hljs-keyword">for</span> (i = <span class="hljs-number">0</span>; i &lt; length; i++) {
      ...
      <span class="hljs-keyword">switch</span> (len) {
        ...
        <span class="hljs-keyword">case</span> <span class="hljs-number">4</span>: listeners[i].fn.call(listeners[i].context, a1, a2, a3); <span class="hljs-keyword">break</span>;
...
<span>The context to invoke the listener with.
  ...
  <span class="hljs-keyword">return</span> addListener(<span class="hljs-keyword">this</span>, event, fn, context, <span class="hljs-literal">false</span>);
};
...
<span>The context to invoke the listener with.
  ...
  <span class="hljs-keyword">return</span> addListener(<span class="hljs-keyword">this</span>, event, fn, context, <span class="hljs-literal">true</span>);
};
...
<span class="dox_tag_name">fn</span>
<span class="dox_type">Function</span>
<span>Only remove the listeners that match this function.
</span>
</div>
<div class="dox_tag_detail">
<span class="dox_tag_name">context</span>
<span>Only remove the listeners that have this context.
</span>
</div>
<div class="dox_tag_detail">
<span class="dox_tag_name">once</span>
<span class="dox_type">Boolean</span>
<span>Only remove one-time listeners.
</span>
</div>
</div>
</div>
  ...
  <span class="hljs-keyword">if</span> (!<span class="hljs-keyword">this</span>._events[evt]) <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>;
  <span class="hljs-keyword">if</span> (!fn) {
    clearEvent(<span class="hljs-keyword">this</span>, evt);
  ...
  <span class="hljs-keyword">if</span> (listeners.fn) {
    ...
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>, events = [], length = listeners.length; i &lt; length; i++) {
      <span class="hljs-keyword">if</span> (
        listeners[i].fn !== fn ||
...
<p>Reset the array, or remove it completely if we have no more listeners.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    <span class="hljs-keyword">if</span> (events.length) <span class="hljs-keyword">this</span>._events[evt] = events.length === <span class="hljs-number">1</span> ? events[<span class="hljs-number">0</span>] : events;
    <span class="hljs-keyword">else</span> clearEvent(<span class="hljs-keyword">this</span>, evt);
  }
...
<span>The event name.
  ...
  <span class="hljs-keyword">if</span> (event) {
    evt = prefix ? prefix + event : event;
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>._events[evt]) clearEvent(<span class="hljs-keyword">this</span>, evt);
  } <span class="hljs-keyword">else</span> {
    <span class="hljs-keyword">this</span>._events = <span class="hljs-keyword">new</span> Events();
    <span class="hljs-keyword">this</span>._eventsCount = <span class="hljs-number">0</span>;
  }
...
<p>Allow <code>EventEmitter</code> to be imported as module namespace.</p>
