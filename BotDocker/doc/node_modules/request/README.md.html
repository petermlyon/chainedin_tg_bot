...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/request/README.md";
...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h1">
        <a href="#request-simplified-http-client">Request - Simplified HTTP client</a>
      </div>
  ...
  <div id="container">
    <div class="docs markdown"><div class="pilwrap" id="deprecated">
  <h1>
...
<a href="https://github.com/request/request/issues/3142">this issue</a>.</p>
<div class="pilwrap" id="request-simplified-http-client">
  <h1>
    <a href="#request-simplified-http-client" name="request-simplified-http-client" class="pilcrow"></a>
...
<li><a href="#oauth-signing.html">OAuth Signing</a></li>
...
<div class="pilwrap" id="oauth-signing">
  <h2>
    <a href="#oauth-signing" name="oauth-signing" class="pilcrow"></a>
OAuth Signing
  </h2>
</div>
...
<pre><code class="js"><span class="hljs-comment">// OAuth1.0 - 3-legged server side flow (Twitter example)</span>
...
request.post({<span class="hljs-attr">url</span>:url, <span class="hljs-attr">oauth</span>:oauth}, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">e, r, body</span>) </span>{
  ...
  <span class="hljs-keyword">const</span> req_data = qs.parse(body)
  <span class="hljs-keyword">const</span> uri = <span class="hljs-string">'https://api.twitter.com/oauth/authenticate'</span>
  ...
  <span class="hljs-keyword">const</span> auth_data = qs.parse(body)
    , oauth =
      { <span class="hljs-attr">consumer_key</span>: CONSUMER_KEY
      , <span class="hljs-attr">consumer_secret</span>: CONSUMER_SECRET
  ...
  request.post({<span class="hljs-attr">url</span>:url, <span class="hljs-attr">oauth</span>:oauth}, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">e, r, body</span>) </span>{
    ...
    <span class="hljs-keyword">const</span> perm_data = qs.parse(body)
      , oauth =
        { <span class="hljs-attr">consumer_key</span>: CONSUMER_KEY
        , <span class="hljs-attr">consumer_secret</span>: CONSUMER_SECRET
...
<li>
<p>Use the <a href="https://github.com/request/request-debug">request-debug module</a> to
