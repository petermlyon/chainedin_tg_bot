...
<head>
  ...
  <script>
    var relativeDir = "../../../";
    var thisFile = "node_modules/@cypress/request/README.md";
...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h1">
        <a href="#@cypressrequest-simplified-http-client">@cypress/request - Simplified HTTP client</a>
      </div>
      ...
      <div class="heading h2">
        <a href="#promises-and-asyncawait">Promises &amp;amp; Async/Await</a>
      </div>
      ...
      <div class="heading h4">
        <a href="#applicationx-www-form-urlencoded-url-encoded-forms">application/x-www-form-urlencoded (URL-Encoded Forms)</a>
      </div>

      <div class="heading h4">
        <a href="#multipartform-data-multipart-form-uploads">multipart/form-data (Multipart Form Uploads)</a>
      </div>

      <div class="heading h4">
        <a href="#multipartrelated">multipart/related</a>
      </div>

      <div class="heading h2">
        <a href="#http-authentication">HTTP Authentication</a>
      </div>
      ...
      <div class="heading h3">
        <a href="#controlling-proxy-behaviour-using-environment-variables">Controlling proxy behaviour using environment variables</a>
      </div>

      <div class="heading h2">
        <a href="#unix-domain-sockets">UNIX Domain Sockets</a>
      </div>

      <div class="heading h2">
        <a href="#tlsssl-protocol">TLS/SSL Protocol</a>
      </div>

      <div class="heading h3">
        <a href="#using-options.agentoptions">Using options.agentOptions</a>
      </div>

      <div class="heading h2">
        <a href="#support-for-har-1.2">Support for HAR 1.2</a>
      </div>
      ...
      <div class="heading h3">
        <a href="#request.method">request.METHOD()</a>
      </div>
      ...
      <div class="heading h3">
        <a href="#response.caseless.get-header-name">response.caseless.get(&#39;header-name&#39;)</a>
      </div>
  ...
  <div id="container">
    <div class="docs markdown"><div class="pilwrap" id="@cypressrequest-simplified-http-client">
  <h1>
    <a href="#@cypressrequest-simplified-http-client" name="@cypressrequest-simplified-http-client" class="pilcrow"></a>
@cypress/request - Simplified HTTP client
  </h1>
</div>
<p><a href="https://nodei.co/npm/@cypress/request/"><img src="https://nodei.co/npm/@cypress/request.png?downloads=true&amp;downloadRank=true&amp;stars=true" alt="npm package"></a></p>
<p><strong>This is a fork of <a href="https://github.com/request/request"><code>request</code></a> for use in <a href="https://github.com/cypress-io/cypress">Cypress</a>.</strong></p>
<div class="pilwrap" id="super-simple-to-use">
  <h2>
    <a href="#super-simple-to-use" name="super-simple-to-use" class="pilcrow"></a>
Super simple to use
  </h2>
</div>
...
<pre><code class="js"><span class="hljs-keyword">const</span> request = <span class="hljs-built_in">require</span>(<span class="hljs-string">'@cypress/request'</span>);
request(<span class="hljs-string">'http://www.google.com'</span>, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">error, response, body</span>) </span>{
  <span class="hljs-built_in">console</span>.error(<span class="hljs-string">'error:'</span>, error); <span class="hljs-comment">// Print the error if one occurred</span>
...
<li><a href="#promises--asyncawait.html">Promises &amp; Async/Await</a></li>
<li><a href="#forms.html">Forms</a></li>
<li><a href="#http-authentication.html">HTTP Authentication</a></li>
<li><a href="#custom-http-headers.html">Custom HTTP Headers</a></li>
<li><a href="#proxies.html">Proxies</a></li>
<li><a href="#unix-domain-sockets.html">Unix Domain Sockets</a></li>
<li><a href="#tlsssl-protocol.html">TLS/SSL Protocol</a></li>
<li><a href="#support-for-har-12.html">Support for HAR 1.2</a></li>
<li><a href="#requestoptions-callback.html"><strong>All Available Options</strong></a></li>
</ul>
<p>Request also offers <a href="#convenience-methods.html">convenience methods</a> like
<code>request.defaults</code> and <code>request.post</code>, and there are
lots of <a href="#examples.html">usage examples</a> and several
<a href="#debugging.html">debugging techniques</a>.</p>
<hr>
...
<pre><code class="js">request(<span class="hljs-string">'http://google.com/doodle.png'</span>).pipe(fs.createWriteStream(<span class="hljs-string">'doodle.png'</span>))
</code></pre>
...
<pre><code class="js">fs.createReadStream(<span class="hljs-string">'file.json'</span>).pipe(request.put(<span class="hljs-string">'http://mysite.com/obj.json'</span>))
</code></pre>
...
<pre><code class="js">request.get(<span class="hljs-string">'http://google.com/img.png'</span>).pipe(request.put(<span class="hljs-string">'http://mysite.com/img.png'</span>))
</code></pre>
...
<pre><code class="js">http.createServer(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">req, resp</span>) </span>{
...
<pre><code class="js">http.createServer(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">req, resp</span>) </span>{
  <span class="hljs-keyword">if</span> (req.url === <span class="hljs-string">'/doodle.png'</span>) {
    <span class="hljs-keyword">const</span> x = request(<span class="hljs-string">'http://mysite.com/doodle.png'</span>)
    req.pipe(x)
    x.pipe(resp)
  }
})
...
<pre><code class="js">req.pipe(request(<span class="hljs-string">'http://mysite.com/doodle.png'</span>)).pipe(resp)
</code></pre>
<p>Also, none of this new functionality conflicts with requests previous features, it just expands them.</p>
<pre><code class="js"><span class="hljs-keyword">const</span> r = request.defaults({<span class="hljs-string">'proxy'</span>:<span class="hljs-string">'http://localproxy.com'</span>})
...
<p><a href="#table-of-contents.html">back to top</a></p>
<hr>
<div class="pilwrap" id="promises-and-asyncawait">
  <h2>
    <a href="#promises-and-asyncawait" name="promises-and-asyncawait" class="pilcrow"></a>
...
<ul>
<li><a href="https://github.com/cypress-io/request-promise"><code>request-promise</code></a> (uses <a href="https://github.com/petkaantonov/bluebird">Bluebird</a> Promises)</li>
<li><a href="https://github.com/cypress-io/request-promise-native"><code>request-promise-native</code></a> (uses native Promises)</li>
<li><a href="https://github.com/cypress-io/request-promise-any"><code>request-promise-any</code></a> (uses <a href="https://www.npmjs.com/package/any-promise">any-promise</a> Promises)</li>
</ul>
<p>Also, <a href="https://nodejs.org/api/util.html#util_util_promisify_original"><code>util.promisify</code></a>, which is available from Node.js v8.0 can be used to convert a regular function that takes a callback to return a promise instead.</p>
<p><a href="#table-of-contents.html">back to top</a></p>
<hr>
<div class="pilwrap" id="forms">
  <h2>
    <a href="#forms" name="forms" class="pilcrow"></a>
Forms
  </h2>
</div>
...
<div class="pilwrap" id="applicationx-www-form-urlencoded-url-encoded-forms">
  <h4>
    <a href="#applicationx-www-form-urlencoded-url-encoded-forms" name="applicationx-www-form-urlencoded-url-encoded-forms" class="pilcrow"></a>
application/x-www-form-urlencoded (URL-Encoded Forms)
  </h4>
</div>
<p>URL-encoded forms are simple.</p>
<pre><code class="js">request.post(<span class="hljs-string">'http://service.com/upload'</span>, {<span class="hljs-attr">form</span>:{<span class="hljs-attr">key</span>:<span class="hljs-string">'value'</span>}})
...
<div class="pilwrap" id="multipartform-data-multipart-form-uploads">
  <h4>
    <a href="#multipartform-data-multipart-form-uploads" name="multipartform-data-multipart-form-uploads" class="pilcrow"></a>
...
<pre><code class="js"><span class="hljs-keyword">const</span> formData = {
  ...
  <span class="hljs-attr">my_buffer</span>: Buffer.from([<span class="hljs-number">1</span>, <span class="hljs-number">2</span>, <span class="hljs-number">3</span>]),
  ...
  <span class="hljs-attr">custom_file</span>: {
...
<pre><code class="js"><span class="hljs-comment">// <span class="hljs-doctag">NOTE:</span> Advanced use-case, for normal use see 'formData' usage above</span>
<span class="hljs-keyword">const</span> r = request.post(<span class="hljs-string">'http://service.com/upload'</span>, <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">optionalCallback</span>(<span class="hljs-params">err, httpResponse, body</span>) </span>{...})
<span class="hljs-keyword">const</span> form = r.form();
...
<div class="pilwrap" id="multipartrelated">
  <h4>
    <a href="#multipartrelated" name="multipartrelated" class="pilcrow"></a>
multipart/related
  </h4>
</div>
...
<p><a href="#table-of-contents.html">back to top</a></p>
<hr>
<div class="pilwrap" id="http-authentication">
  <h2>
    <a href="#http-authentication" name="http-authentication" class="pilcrow"></a>
HTTP Authentication
  </h2>
</div>
<pre><code class="js">request.get(<span class="hljs-string">'http://some.server.com/'</span>).auth(<span class="hljs-string">'username'</span>, <span class="hljs-string">'password'</span>, <span class="hljs-literal">false</span>);
<span class="hljs-comment">// or</span>
...
<pre><code class="js"><span class="hljs-keyword">const</span> username = <span class="hljs-string">'username'</span>,
...
<p><a href="#table-of-contents.html">back to top</a></p>
<hr>
<div class="pilwrap" id="custom-http-headers">
  <h2>
    <a href="#custom-http-headers" name="custom-http-headers" class="pilcrow"></a>
Custom HTTP Headers
  </h2>
</div>
...
<pre><code class="js"><span class="hljs-keyword">const</span> request = <span class="hljs-built_in">require</span>(<span class="hljs-string">'request'</span>);

<span class="hljs-keyword">const</span> options = {
  <span class="hljs-attr">url</span>: <span class="hljs-string">'https://api.github.com/repos/cypress-io/request'</span>,
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">callback</span>(<span class="hljs-params">error, response, body</span>) </span>{
  <span class="hljs-keyword">if</span> (!error &amp;&amp; response.statusCode == <span class="hljs-number">200</span>) {
    <span class="hljs-keyword">const</span> info = <span class="hljs-built_in">JSON</span>.parse(body);
...
<p><a href="#table-of-contents.html">back to top</a></p>
<hr>
<div class="pilwrap" id="proxies">
  <h2>
    <a href="#proxies" name="proxies" class="pilcrow"></a>
Proxies
  </h2>
</div>
...
<div class="pilwrap" id="controlling-proxy-behaviour-using-environment-variables">
  <h3>
    <a href="#controlling-proxy-behaviour-using-environment-variables" name="controlling-proxy-behaviour-using-environment-variables" class="pilcrow"></a>
...
<p><a href="#table-of-contents.html">back to top</a></p>
<hr>
<div class="pilwrap" id="unix-domain-sockets">
  <h2>
    <a href="#unix-domain-sockets" name="unix-domain-sockets" class="pilcrow"></a>
UNIX Domain Sockets
  </h2>
</div>
...
<pre><code class="js"><span class="hljs-comment">/* Pattern */</span> <span class="hljs-string">'http://unix:SOCKET:PATH'</span>
...
<p><a href="#table-of-contents.html">back to top</a></p>
<hr>
<div class="pilwrap" id="tlsssl-protocol">
  <h2>
    <a href="#tlsssl-protocol" name="tlsssl-protocol" class="pilcrow"></a>
TLS/SSL Protocol
  </h2>
</div>
...
<div class="pilwrap" id="using-options.agentoptions">
  <h3>
    <a href="#using-options.agentoptions" name="using-options.agentoptions" class="pilcrow"></a>
Using <code>options.agentOptions</code>
  </h3>
</div>
...
<p>The <code>ca</code> value can be an array of certificates, in the event you have a private or internal corporate public-key infrastructure hierarchy. For example, if you want to connect to https://api.some-server.com which presents a key chain consisting of:</p>
<ol>
...
<pre><code class="js">request.get({
    ...
    <span class="hljs-attr">agentOptions</span>: {
        <span class="hljs-attr">ca</span>: [
          fs.readFileSync(<span class="hljs-string">'Corp Issuing Server.pem'</span>),
          fs.readFileSync(<span class="hljs-string">'Corp Root CA.pem'</span>)
        ]
    }
});
</code></pre>
<p><a href="#table-of-contents.html">back to top</a></p>
<hr>
<div class="pilwrap" id="support-for-har-1.2">
  <h2>
    <a href="#support-for-har-1.2" name="support-for-har-1.2" class="pilcrow"></a>
Support for HAR 1.2
  </h2>
</div>
...
<div class="pilwrap" id="request-options-callback">
  <h2>
    <a href="#request-options-callback" name="request-options-callback" class="pilcrow"></a>
request(options, callback)
  </h2>
</div>
...
<a href="#forms.html">Forms</a> section above.</li>
<li><code>multipart</code> - array of objects which contain their own headers and <code>body</code>
attributes. Sends a <code>multipart/related</code> request. See <a href="#forms.html">Forms</a> section
above.
<ul>
...
<hr>
<ul>
<li><code>followRedirect</code> - follow HTTP 3xx responses as redirects (default: <code>true</code>). This property can also be implemented as function which gets <code>response</code> object as the first argument.
<ul>
<li><em>(synchronous usage)</em> It should return <code>true</code> if redirects should continue or <code>false</code> otherwise. If it returns a url string, the destination of the redirect will be overridden.</li>
<li><em>(async callback usage)</em> If the function has two arguments, it will be treated as an asynchronous function and will be passed a callback as the second argument. Invoke the callback with an error (<code>null</code> if no error) and the boolean/url result as the second.</li>
...
<li><code>allowInsecureRedirect</code> - allows cross-protocol redirects (HTTP to HTTPS and vice versa). <strong>Warning:</strong> may lead to bypassing anti SSRF filters (default: <code>false</code>)</li>
</ul>
<hr>
<ul>
...
<li><code>agentOptions</code> - and pass its options. <strong>Note:</strong> for HTTPS see <a href="http://nodejs.org/api/tls.html#tls_tls_connect_options_callback">tls API doc for TLS/SSL options</a> and the <a href="#using-optionsagentoptions.html">documentation above</a>.</li>
...
work around this, either use <a href="#requestdefaultsoptions.html"><code>request.defaults</code></a>
...
<ul>
<li>
<p><code>time</code> - if <code>true</code>, the request-response cycle (including all redirects) is timed at millisecond resolution. When set, the following properties are added to the response object:</p>
<ul>
...
<li>
<p><code>har</code> - a <a href="http://www.softwareishard.com/blog/har-12-spec/#request">HAR 1.2 Request Object</a>, will be processed from HAR format into options overwriting matching values <em>(see the <a href="#support-for-har-12.html">HAR 1.2 section</a> for details)</em></p>
</li>
<li>
<p><code>callback</code> - alternatively pass the request's callback in the options object</p>
</li>
</ul>
...
<div class="pilwrap" id="convenience-methods">
  <h2>
    <a href="#convenience-methods" name="convenience-methods" class="pilcrow"></a>
Convenience methods
  </h2>
</div>
...
<div class="pilwrap" id="request.defaults-options">
  <h3>
    <a href="#request.defaults-options" name="request.defaults-options" class="pilcrow"></a>
...
<p>For example:</p>
<pre><code class="js"><span class="hljs-comment">//requests using baseRequest() will set the 'x-token' header</span>
<span class="hljs-keyword">const</span> baseRequest = request.defaults({
...
<span class="hljs-keyword">const</span> specialRequest = baseRequest.defaults({
  <span class="hljs-attr">headers</span>: {<span class="hljs-attr">special</span>: <span class="hljs-string">'special value'</span>}
})
</code></pre>
<div class="pilwrap" id="request.method">
  <h3>
    <a href="#request.method" name="request.method" class="pilcrow"></a>
request.METHOD()
  </h3>
</div>
...
<div class="pilwrap" id="request.cookie">
  <h3>
    <a href="#request.cookie" name="request.cookie" class="pilcrow"></a>
request.cookie()
  </h3>
</div>
<p>Function that creates a new cookie.</p>
<pre><code class="js">request.cookie(<span class="hljs-string">'key1=value1'</span>)
</code></pre>
<div class="pilwrap" id="request.jar">
  <h3>
    <a href="#request.jar" name="request.jar" class="pilcrow"></a>
request.jar()
  </h3>
</div>
...
<div class="pilwrap" id="response.caseless.get-header-name">
  <h3>
    <a href="#response.caseless.get-header-name" name="response.caseless.get-header-name" class="pilcrow"></a>
...
<pre><code class="js">request(<span class="hljs-string">'http://www.google.com'</span>, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">error, response, body</span>) </span>{
  <span class="hljs-comment">// print the Content-Type header even if the server returned it as 'content-type' (lowercase)</span>
  <span class="hljs-built_in">console</span>.log(<span class="hljs-string">'Content-Type is:'</span>, response.caseless.get(<span class="hljs-string">'Content-Type'</span>));
});
</code></pre>
<p><a href="#table-of-contents.html">back to top</a></p>
<hr>
...
<li>
<p>Use the <a href="https://github.com/cypress-io/request-debug">request-debug module</a> to
view request and response headers and bodies.</p>
</li>
</ol>
<p><a href="#table-of-contents.html">back to top</a></p>
<hr>
<div class="pilwrap" id="timeouts">
  <h2>
    <a href="#timeouts" name="timeouts" class="pilcrow"></a>
Timeouts
  </h2>
</div>
...
<pre><code class="js">request.get(<span class="hljs-string">'http://10.255.255.1'</span>, {<span class="hljs-attr">timeout</span>: <span class="hljs-number">1500</span>}, <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">err</span>) </span>{
...
<pre><code class="js"><span class="hljs-keyword">const</span> request = request.defaults({<span class="hljs-attr">jar</span>: <span class="hljs-literal">true</span>})
...
<pre><code class="js"><span class="hljs-keyword">const</span> j = request.jar()
<span class="hljs-keyword">const</span> request = request.defaults({<span class="hljs-attr">jar</span>:j})
request(<span class="hljs-string">'http://www.google.com'</span>, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
  request(<span class="hljs-string">'http://images.google.com'</span>)
})
</code></pre>
<p>OR</p>
<pre><code class="js"><span class="hljs-keyword">const</span> j = request.jar();
<span class="hljs-keyword">const</span> cookie = request.cookie(<span class="hljs-string">'key1=value1'</span>);
...
<pre><code class="js"><span class="hljs-keyword">const</span> FileCookieStore = <span class="hljs-built_in">require</span>(<span class="hljs-string">'tough-cookie-filestore'</span>);
<span class="hljs-comment">// NOTE - currently the 'cookies.json' file must already exist!</span>
<span class="hljs-keyword">const</span> j = request.jar(<span class="hljs-keyword">new</span> FileCookieStore(<span class="hljs-string">'cookies.json'</span>));
...
request({<span class="hljs-attr">url</span>: <span class="hljs-string">'http://www.google.com'</span>, <span class="hljs-attr">jar</span>: j}, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
  <span class="hljs-keyword">const</span> cookie_string = j.getCookieString(url); <span class="hljs-comment">// "key1=value1; key2=value2; ..."</span>
  <span class="hljs-keyword">const</span> cookies = j.getCookies(url);
