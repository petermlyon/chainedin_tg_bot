...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">parse</span>(<span class="hljs-params">str</span>) </span>{
  ...
  <span class="hljs-keyword">var</span> match = <span class="hljs-regexp">/^(-?(?:\d+)?\.?\d+) *(milliseconds?|msecs?|ms|seconds?|secs?|s|minutes?|mins?|m|hours?|hrs?|h|days?|d|weeks?|w|years?|yrs?|y)?$/i</span>.exec(
    str
  );
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">fmtShort</span>(<span class="hljs-params">ms</span>) </span>{
  <span class="hljs-keyword">var</span> msAbs = <span class="hljs-built_in">Math</span>.abs(ms);
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">fmtLong</span>(<span class="hljs-params">ms</span>) </span>{
  <span class="hljs-keyword">var</span> msAbs = <span class="hljs-built_in">Math</span>.abs(ms);
  <span class="hljs-keyword">if</span> (msAbs &gt;= d) {
    <span class="hljs-keyword">return</span> plural(ms, msAbs, d, <span class="hljs-string">'day'</span>);
  }
  <span class="hljs-keyword">if</span> (msAbs &gt;= h) {
    <span class="hljs-keyword">return</span> plural(ms, msAbs, h, <span class="hljs-string">'hour'</span>);
  }
  <span class="hljs-keyword">if</span> (msAbs &gt;= m) {
    <span class="hljs-keyword">return</span> plural(ms, msAbs, m, <span class="hljs-string">'minute'</span>);
  }
  <span class="hljs-keyword">if</span> (msAbs &gt;= s) {
    <span class="hljs-keyword">return</span> plural(ms, msAbs, s, <span class="hljs-string">'second'</span>);
  }
  <span class="hljs-keyword">return</span> ms + <span class="hljs-string">' ms'</span>;
}
...
<div class="body">
        ...
        <td class="code highlight">
          <pre class="javascript">
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">plural</span>(<span class="hljs-params">ms, msAbs, n, name</span>) </span>{
  <span class="hljs-keyword">var</span> isPlural = msAbs &gt;= n * <span class="hljs-number">1.5</span>;
  <span class="hljs-keyword">return</span> <span class="hljs-built_in">Math</span>.round(ms / n) + <span class="hljs-string">' '</span> + name + (isPlural ? <span class="hljs-string">'s'</span> : <span class="hljs-string">''</span>);
}
