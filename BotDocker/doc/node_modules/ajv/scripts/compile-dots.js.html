...
<head>
  ...
  <script>
    var relativeDir = "../../../";
    var thisFile = "node_modules/ajv/scripts/compile-dots.js";
...
files.forEach(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">f</span>) </span>{
  ...
  code = code.toString()
             ...
             .replace(FUNCTION_NAME, <span class="hljs-string">'function generate_'</span> + keyword + <span class="hljs-string">'(it, $keyword, $ruleType) {'</span>)
