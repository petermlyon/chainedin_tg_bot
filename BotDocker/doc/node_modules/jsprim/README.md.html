...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/jsprim/README.md";
...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h3">
        <a href="#haskey-obj-key">hasKey(obj, key)</a>
      </div>
      ...
      <div class="heading h3">
        <a href="#parseinteger-str-options">parseInteger(str, options)</a>
      </div>
...
<div class="pilwrap" id="haskey-obj-key">
  <h3>
    <a href="#haskey-obj-key" name="haskey-obj-key" class="pilcrow"></a>
hasKey(obj, key)
  </h3>
</div>
...
otherwise.</p>
<div class="pilwrap" id="parseinteger-str-options">
  <h3>
    <a href="#parseinteger-str-options" name="parseinteger-str-options" class="pilcrow"></a>
...
<td>boolean</td>
<td>true</td>
<td>whether to interpret any leading <code>+</code> (positive) and <code>-</code> (negative) characters</td>
</tr>
<tr>
<td>allowImprecise</td>
<td>boolean</td>
<td>false</td>
<td>whether to accept values that may have lost precision (past <code>MAX_SAFE_INTEGER</code> or below <code>MIN_SAFE_INTEGER</code>)</td>
</tr>
<tr>
<td>allowPrefix</td>
<td>boolean</td>
<td>false</td>
<td>whether to interpret the prefixes <code>0b</code> (base 2), <code>0o</code> (base 8), <code>0t</code> (base 10), or <code>0x</code> (base 16)</td>
</tr>
<tr>
<td>allowTrailing</td>
<td>boolean</td>
