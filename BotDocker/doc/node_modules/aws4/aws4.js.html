...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/aws4/aws4.js";
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">encodeRfc3986Full</span>(<span class="hljs-params">str</span>) </span>{
  <span class="hljs-keyword">return</span> encodeRfc3986(<span class="hljs-built_in">encodeURIComponent</span>(str))
}
...
<p>A bit of a combination of:
https://github.com/aws/aws-sdk-java-v2/blob/dc695de6ab49ad03934e1b02e7263abbd2354be0/core/auth/src/main/java/software/amazon/awssdk/auth/signer/internal/AbstractAws4Signer.java#L59
https://github.com/aws/aws-sdk-js/blob/18cb7e5b463b46239f9fdd4a65e2ff8c81831e8f/lib/signers/v4.js#L191-L199
https://github.com/mhart/aws4fetch/blob/b3aed16b6f17384cf36ea33bcba3c1e9f3bdfefd/src/main.js#L25-L34</p>

        </td>
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-keyword">var</span> HEADERS_TO_IGNORE = {
  <span class="hljs-string">'authorization'</span>: <span class="hljs-literal">true</span>,
  <span class="hljs-string">'connection'</span>: <span class="hljs-literal">true</span>,
  <span class="hljs-string">'x-amzn-trace-id'</span>: <span class="hljs-literal">true</span>,
  <span class="hljs-string">'user-agent'</span>: <span class="hljs-literal">true</span>,
  <span class="hljs-string">'expect'</span>: <span class="hljs-literal">true</span>,
  <span class="hljs-string">'presigned-expires'</span>: <span class="hljs-literal">true</span>,
  <span class="hljs-string">'range'</span>: <span class="hljs-literal">true</span>,
}
...
credentials: { accessKeyId, secretAccessKey, [sessionToken] }</p>
  ...
  <span class="hljs-keyword">var</span> headers = request.headers = <span class="hljs-built_in">Object</span>.assign({}, (request.headers || {})),
      hostParts = (!<span class="hljs-keyword">this</span>.service || !<span class="hljs-keyword">this</span>.region) &amp;&amp; <span class="hljs-keyword">this</span>.matchHost(request.hostname || request.host || headers.Host || headers.host)
...
<p>If a port is specified explicitly, use it as is</p>
  ...
  <span class="hljs-keyword">this</span>.extraHeadersToIgnore = request.extraHeadersToIgnore || <span class="hljs-built_in">Object</span>.create(<span class="hljs-literal">null</span>)
  <span class="hljs-keyword">this</span>.extraHeadersToInclude = request.extraHeadersToInclude || <span class="hljs-built_in">Object</span>.create(<span class="hljs-literal">null</span>)
}
...
RequestSigner.prototype.matchHost = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">host</span>) </span>{
  <span class="hljs-keyword">var</span> match = (host || <span class="hljs-string">''</span>).match(<span class="hljs-regexp">/([^\.]{1,63})\.(?:([^\.]{0,63})\.)?amazonaws\.com(\.cn)?$/</span>)
...
e.g. search-cluster-name-aaaa00aaaa0aaa0aaaaaaa0aaa.us-east-1.es.amazonaws.com</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">if</span> (hostParts[<span class="hljs-number">1</span>] === <span class="hljs-string">'es'</span> || hostParts[<span class="hljs-number">1</span>] === <span class="hljs-string">'aoss'</span>)
    hostParts = hostParts.reverse()

  <span class="hljs-keyword">if</span> (hostParts[<span class="hljs-number">1</span>] == <span class="hljs-string">'s3'</span>) {
    hostParts[<span class="hljs-number">0</span>] = <span class="hljs-string">'s3'</span>
    hostParts[<span class="hljs-number">1</span>] = <span class="hljs-string">'us-east-1'</span>
    ...
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> i = <span class="hljs-number">0</span>; i &lt; <span class="hljs-number">2</span>; i++) {
      <span class="hljs-keyword">if</span> (<span class="hljs-regexp">/^s3-/</span>.test(hostParts[i])) {
        hostParts[<span class="hljs-number">1</span>] = hostParts[i].slice(<span class="hljs-number">3</span>)
        hostParts[<span class="hljs-number">0</span>] = <span class="hljs-string">'s3'</span>
...
RequestSigner.prototype.createHost = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
  <span class="hljs-keyword">var</span> region = <span class="hljs-keyword">this</span>.isSingleRegion() ? <span class="hljs-string">''</span> : <span class="hljs-string">'.'</span> + <span class="hljs-keyword">this</span>.region,
      subdomain = <span class="hljs-keyword">this</span>.service === <span class="hljs-string">'ses'</span> ? <span class="hljs-string">'email'</span> : <span class="hljs-keyword">this</span>.service
  <span class="hljs-keyword">return</span> subdomain + region + <span class="hljs-string">'.amazonaws.com'</span>
}
...
RequestSigner.prototype.canonicalString = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
  ...
  <span class="hljs-keyword">if</span> (query) {
    <span class="hljs-keyword">var</span> reducedQuery = <span class="hljs-built_in">Object</span>.keys(query).reduce(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">obj, key</span>) </span>{
      <span class="hljs-keyword">if</span> (!key) <span class="hljs-keyword">return</span> obj
      obj[encodeRfc3986Full(key)] = !<span class="hljs-built_in">Array</span>.isArray(query[key]) ? query[key] :
        (firstValOnly ? query[key][<span class="hljs-number">0</span>] : query[key])
      <span class="hljs-keyword">return</span> obj
    }, {})
    <span class="hljs-keyword">var</span> encodedQueryPieces = []
    <span class="hljs-built_in">Object</span>.keys(reducedQuery).sort().forEach(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">key</span>) </span>{
      <span class="hljs-keyword">if</span> (!<span class="hljs-built_in">Array</span>.isArray(reducedQuery[key])) {
        encodedQueryPieces.push(key + <span class="hljs-string">'='</span> + encodeRfc3986Full(reducedQuery[key]))
      } <span class="hljs-keyword">else</span> {
        reducedQuery[key].map(encodeRfc3986Full).sort()
          .forEach(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">val</span>) </span>{ encodedQueryPieces.push(key + <span class="hljs-string">'='</span> + val) })
      }
    })
    queryStr = encodedQueryPieces.join(<span class="hljs-string">'&amp;'</span>)
  }
  <span class="hljs-keyword">if</span> (pathStr !== <span class="hljs-string">'/'</span>) {
    ...
    pathStr = pathStr.split(<span class="hljs-string">'/'</span>).reduce(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">path, piece</span>) </span>{
      <span class="hljs-keyword">if</span> (normalizePath &amp;&amp; piece === <span class="hljs-string">'..'</span>) {
        ...
        <span class="hljs-keyword">if</span> (decodePath) piece = <span class="hljs-built_in">decodeURIComponent</span>(piece.replace(<span class="hljs-regexp">/\+/g</span>, <span class="hljs-string">' '</span>))
...
RequestSigner.prototype.filterHeaders = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
  <span class="hljs-keyword">var</span> headers = <span class="hljs-keyword">this</span>.request.headers,
      extraHeadersToInclude = <span class="hljs-keyword">this</span>.extraHeadersToInclude,
      extraHeadersToIgnore = <span class="hljs-keyword">this</span>.extraHeadersToIgnore
  <span class="hljs-keyword">this</span>.filteredHeaders = <span class="hljs-built_in">Object</span>.keys(headers)
    .map(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">key</span>) </span>{ <span class="hljs-keyword">return</span> [key.toLowerCase(), headers[key]] })
    .filter(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">entry</span>) </span>{
      <span class="hljs-keyword">return</span> extraHeadersToInclude[entry[<span class="hljs-number">0</span>]] ||
        (HEADERS_TO_IGNORE[entry[<span class="hljs-number">0</span>]] == <span class="hljs-literal">null</span> &amp;&amp; !extraHeadersToIgnore[entry[<span class="hljs-number">0</span>]])
    })
    .sort(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">a, b</span>) </span>{ <span class="hljs-keyword">return</span> a[<span class="hljs-number">0</span>] &lt; b[<span class="hljs-number">0</span>] ? <span class="hljs-number">-1</span> : <span class="hljs-number">1</span> })
}
...
RequestSigner.prototype.canonicalHeaders = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
  <span class="hljs-keyword">if</span> (!<span class="hljs-keyword">this</span>.filteredHeaders) <span class="hljs-keyword">this</span>.filterHeaders()

  <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.filteredHeaders.map(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">entry</span>) </span>{
    <span class="hljs-keyword">return</span> entry[<span class="hljs-number">0</span>] + <span class="hljs-string">':'</span> + entry[<span class="hljs-number">1</span>].toString().trim().replace(<span class="hljs-regexp">/\s+/g</span>, <span class="hljs-string">' '</span>)
  }).join(<span class="hljs-string">'\n'</span>)
}
...
RequestSigner.prototype.signedHeaders = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
  ...
  <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.filteredHeaders.map(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">entry</span>) </span>{ <span class="hljs-keyword">return</span> entry[<span class="hljs-number">0</span>] }).join(<span class="hljs-string">';'</span>)
}
...
So if there are non-reserved chars (and it's not already all % encoded), just encode them all</p>
    ...
    path = <span class="hljs-built_in">encodeURI</span>(<span class="hljs-built_in">decodeURI</span>(path))
  }

  <span class="hljs-keyword">var</span> queryIx = path.indexOf(<span class="hljs-string">'?'</span>),
