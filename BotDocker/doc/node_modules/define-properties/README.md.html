...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/define-properties/README.md";
...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h1">
        <a href="#define-properties">define-properties </a>
      </div>
  ...
  <div id="container">
    <div class="docs markdown"><div class="pilwrap" id="define-properties">
  <h1>
    <a href="#define-properties" name="define-properties" class="pilcrow"></a>
define-properties <sup><a href="https://npmjs.org/package/define-properties"><img src="https://versionbadg.es/ljharb/define-properties.svg" alt="Version Badge"></a></sup>
  </h1>
</div>
<p><a href="https://github.com/ljharb/define-properties/actions"><img src="https://img.shields.io/endpoint?url=https://github-actions-badge-u3jn4tfpocch.runkit.sh/ljharb/define-properties" alt="github actions"></a>
<a href="https://app.codecov.io/gh/ljharb/define-properties/"><img src="https://codecov.io/gh/ljharb/define-properties/branch/main/graphs/badge.svg" alt="coverage"></a>
...
<a href="LICENSE.html"><img src="https://img.shields.io/npm/l/define-properties.svg" alt="License"></a>
<a href="https://npm-stat.com/charts.html?package=define-properties"><img src="https://img.shields.io/npm/dm/define-properties.svg" alt="Downloads"></a></p>
