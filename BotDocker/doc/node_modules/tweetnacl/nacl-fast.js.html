...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/tweetnacl/nacl-fast.js";
...
poly1305.prototype.finish = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">mac, macpos</span>) </span>{
  ...
  mask = (c ^ <span class="hljs-number">1</span>) - <span class="hljs-number">1</span>;
...
<p>TODO: Completely remove this in v0.15.</p>

        </td>
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-keyword">if</span> (!nacl.util) {
  nacl.util = {};
  nacl.util.decodeUTF8 = nacl.util.encodeUTF8 = nacl.util.encodeBase64 = nacl.util.decodeBase64 = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
    <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> <span class="hljs-built_in">Error</span>(<span class="hljs-string">'nacl.util moved into separate package: https://github.com/dchest/tweetnacl-util-js'</span>);
  };
}
...
If not, methods calling randombytes will throw.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">var</span> crypto = <span class="hljs-keyword">typeof</span> self !== <span class="hljs-string">'undefined'</span> ? (self.crypto || self.msCrypto) : <span class="hljs-literal">null</span>;
  <span class="hljs-keyword">if</span> (crypto &amp;&amp; crypto.getRandomValues) {
</pre>
        </td>
      </tr>
...
<p>Browsers.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">    <span class="hljs-keyword">var</span> QUOTA = <span class="hljs-number">65536</span>;
    nacl.setPRNG(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">x, n</span>) </span>{
      ...
      <span class="hljs-keyword">for</span> (i = <span class="hljs-number">0</span>; i &lt; n; i += QUOTA) {
        crypto.getRandomValues(v.subarray(i, i + <span class="hljs-built_in">Math</span>.min(n - i, QUOTA)));
      }
...
<p>Node.js.</p>
    ...
    <span class="hljs-keyword">if</span> (crypto &amp;&amp; crypto.randomBytes) {
      nacl.setPRNG(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">x, n</span>) </span>{
...
})(<span class="hljs-keyword">typeof</span> <span class="hljs-built_in">module</span> !== <span class="hljs-string">'undefined'</span> &amp;&amp; <span class="hljs-built_in">module</span>.exports ? <span class="hljs-built_in">module</span>.exports : (self.nacl = self.nacl || {}));
