...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/punycode/punycode.es6.js";
...
<span class="hljs-keyword">const</span> maxInt = <span class="hljs-number">2147483647</span>; <span class="hljs-comment">// aka. 0x7FFFFFFF or 2^31-1</span>

<span class="hljs-comment">/** Bootstring parameters */</span>
<span class="hljs-keyword">const</span> base = <span class="hljs-number">36</span>;
<span class="hljs-keyword">const</span> tMin = <span class="hljs-number">1</span>;
<span class="hljs-keyword">const</span> tMax = <span class="hljs-number">26</span>;
<span class="hljs-keyword">const</span> skew = <span class="hljs-number">38</span>;
<span class="hljs-keyword">const</span> damp = <span class="hljs-number">700</span>;
<span class="hljs-keyword">const</span> initialBias = <span class="hljs-number">72</span>;
<span class="hljs-keyword">const</span> initialN = <span class="hljs-number">128</span>; <span class="hljs-comment">// 0x80</span>
<span class="hljs-keyword">const</span> delimiter = <span class="hljs-string">'-'</span>; <span class="hljs-comment">// '\x2D'</span>

<span class="hljs-comment">/** Regular expressions */</span>
<span class="hljs-keyword">const</span> regexPunycode = <span class="hljs-regexp">/^xn--/</span>;
<span class="hljs-keyword">const</span> regexNonASCII = <span class="hljs-regexp">/[^\0-\x7F]/</span>; <span class="hljs-comment">// Note: U+007F DEL is excluded too.</span>
<span class="hljs-keyword">const</span> regexSeparators = <span class="hljs-regexp">/[\x2E\u3002\uFF0E\uFF61]/g</span>; <span class="hljs-comment">// RFC 3490 separators</span>
...
<span class="hljs-keyword">const</span> baseMinusTMin = base - tMin;
<span class="hljs-keyword">const</span> floor = <span class="hljs-built_in">Math</span>.floor;
<span class="hljs-keyword">const</span> stringFromCharCode = <span class="hljs-built_in">String</span>.fromCharCode;
...
<span>The function that gets called for every array item.
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">map</span>(<span class="hljs-params">array, callback</span>) </span>{
...
<span>The function that gets called for every character.
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">mapDomain</span>(<span class="hljs-params">domain, callback</span>) </span>{
	<span class="hljs-keyword">const</span> parts = domain.split(<span class="hljs-string">'@'</span>);
...
the local part (i.e. everything up to <code>@</code>) intact.</p>
		...
		domain = parts[<span class="hljs-number">1</span>];
	}
</pre>
        </td>
      </tr>
...
<p>Avoid <code>split(regex)</code> for IE8 compatibility. See #17.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">	domain = domain.replace(regexSeparators, <span class="hljs-string">'\x2E'</span>);
	<span class="hljs-keyword">const</span> labels = domain.split(<span class="hljs-string">'.'</span>);
	<span class="hljs-keyword">const</span> encoded = map(labels, callback).join(<span class="hljs-string">'.'</span>);
...
<span>The Unicode input string (UCS-2).
	...
	<span class="hljs-keyword">const</span> length = string.length;
	<span class="hljs-keyword">while</span> (counter &lt; length) {
		<span class="hljs-keyword">const</span> value = string.charCodeAt(counter++);
...
<p>It's a high surrogate, and there is a next character.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">			<span class="hljs-keyword">const</span> extra = string.charCodeAt(counter++);
...
<span>The array of numeric code points.
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-keyword">const</span> ucs2encode = <span class="hljs-function"><span class="hljs-params">codePoints</span> =&gt;</span> <span class="hljs-built_in">String</span>.fromCodePoint(...codePoints);
...
<span>The basic numeric code point value.
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-keyword">const</span> basicToDigit = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">codePoint</span>) </span>{
	<span class="hljs-keyword">if</span> (codePoint &gt;= <span class="hljs-number">0x30</span> &amp;&amp; codePoint &lt; <span class="hljs-number">0x3A</span>) {
		<span class="hljs-keyword">return</span> <span class="hljs-number">26</span> + (codePoint - <span class="hljs-number">0x30</span>);
	}
	<span class="hljs-keyword">if</span> (codePoint &gt;= <span class="hljs-number">0x41</span> &amp;&amp; codePoint &lt; <span class="hljs-number">0x5B</span>) {
		<span class="hljs-keyword">return</span> codePoint - <span class="hljs-number">0x41</span>;
	}
	<span class="hljs-keyword">if</span> (codePoint &gt;= <span class="hljs-number">0x61</span> &amp;&amp; codePoint &lt; <span class="hljs-number">0x7B</span>) {
...
<span>The numeric value of a basic code point.
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-keyword">const</span> digitToBasic = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">digit, flag</span>) </span>{
</pre>
        </td>
      </tr>
...
<div class="details">
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-keyword">const</span> adapt = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">delta, numPoints, firstTime</span>) </span>{
...
<span>The Punycode string of ASCII-only symbols.
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-keyword">const</span> decode = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">input</span>) </span>{
</pre>
        </td>
      </tr>
...
<p>Don't use UCS-2.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">	<span class="hljs-keyword">const</span> output = [];
	<span class="hljs-keyword">const</span> inputLength = input.length;
	<span class="hljs-keyword">let</span> i = <span class="hljs-number">0</span>;
	<span class="hljs-keyword">let</span> n = initialN;
	<span class="hljs-keyword">let</span> bias = initialBias;
...
the first basic code points to the output.</p>
	...
	<span class="hljs-keyword">let</span> basic = input.lastIndexOf(delimiter);
	<span class="hljs-keyword">if</span> (basic &lt; <span class="hljs-number">0</span>) {
		basic = <span class="hljs-number">0</span>;
	}

	<span class="hljs-keyword">for</span> (<span class="hljs-keyword">let</span> j = <span class="hljs-number">0</span>; j &lt; basic; ++j) {
</pre>
        </td>
      </tr>
...
points were copied; start at the beginning otherwise.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">
	<span class="hljs-keyword">for</span> (<span class="hljs-keyword">let</span> index = basic &gt; <span class="hljs-number">0</span> ? basic + <span class="hljs-number">1</span> : <span class="hljs-number">0</span>; index &lt; inputLength; <span class="hljs-comment">/* no final expression */</span>) {
...
value at the end to obtain <code>delta</code>.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">		<span class="hljs-keyword">const</span> oldi = i;
		<span class="hljs-keyword">for</span> (<span class="hljs-keyword">let</span> w = <span class="hljs-number">1</span>, k = base; <span class="hljs-comment">/* no condition */</span>; k += base) {

			<span class="hljs-keyword">if</span> (index &gt;= inputLength) {
				error(<span class="hljs-string">'invalid-input'</span>);
			}

			<span class="hljs-keyword">const</span> digit = basicToDigit(input.charCodeAt(index++));

			<span class="hljs-keyword">if</span> (digit &gt;= base) {
				error(<span class="hljs-string">'invalid-input'</span>);
			}
			<span class="hljs-keyword">if</span> (digit &gt; floor((maxInt - i) / w)) {
				error(<span class="hljs-string">'overflow'</span>);
			}

			i += digit * w;
			<span class="hljs-keyword">const</span> t = k &lt;= bias ? tMin : (k &gt;= bias + tMax ? tMax : k - bias);

			<span class="hljs-keyword">if</span> (digit &lt; t) {
				<span class="hljs-keyword">break</span>;
			}

			<span class="hljs-keyword">const</span> baseMinusT = base - t;
		...
		<span class="hljs-keyword">const</span> out = output.length + <span class="hljs-number">1</span>;
...
<p>Insert <code>n</code> at position <code>i</code> of the output.</p>
	...
	<span class="hljs-keyword">return</span> <span class="hljs-built_in">String</span>.fromCodePoint(...output);
};
...
<span>The string of Unicode symbols.
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-keyword">const</span> encode = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">input</span>) </span>{
	<span class="hljs-keyword">const</span> output = [];
...
<p>Cache the length.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">	<span class="hljs-keyword">const</span> inputLength = input.length;
...
<p>Initialize the state.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">	<span class="hljs-keyword">let</span> n = initialN;
...
<p>Handle the basic code points.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">	<span class="hljs-keyword">for</span> (<span class="hljs-keyword">const</span> currentValue <span class="hljs-keyword">of</span> input) {
		<span class="hljs-keyword">if</span> (currentValue &lt; <span class="hljs-number">0x80</span>) {
			output.push(stringFromCharCode(currentValue));
		}
	}

	<span class="hljs-keyword">const</span> basicLength = output.length;
	<span class="hljs-keyword">let</span> handledCPCount = basicLength;
...
larger one:</p>
        ...
        <td class="code highlight">
          <pre class="javascript">		<span class="hljs-keyword">let</span> m = maxInt;
		<span class="hljs-keyword">for</span> (<span class="hljs-keyword">const</span> currentValue <span class="hljs-keyword">of</span> input) {
...
but guard against overflow.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">		<span class="hljs-keyword">const</span> handledCPCountPlusOne = handledCPCount + <span class="hljs-number">1</span>;
...
<p>Represent delta as a generalized variable-length integer.</p>
        ...
        <td class="code highlight">
          <pre class="javascript">				<span class="hljs-keyword">let</span> q = delta;
				<span class="hljs-keyword">for</span> (<span class="hljs-keyword">let</span> k = base; <span class="hljs-comment">/* no condition */</span>; k += base) {
					<span class="hljs-keyword">const</span> t = k &lt;= bias ? tMin : (k &gt;= bias + tMax ? tMax : k - bias);
					<span class="hljs-keyword">if</span> (q &lt; t) {
						<span class="hljs-keyword">break</span>;
					}
					<span class="hljs-keyword">const</span> qMinusT = q - t;
					<span class="hljs-keyword">const</span> baseMinusT = base - t;
					output.push(
...
<span>The Punycoded domain name or email address to convert to Unicode.
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-keyword">const</span> toUnicode = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">input</span>) </span>{
...
<span>The domain name or email address to convert, as a Unicode string.
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-keyword">const</span> toASCII = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">input</span>) </span>{
	<span class="hljs-keyword">return</span> mapDomain(input, <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">string</span>) </span>{
...
<span class="hljs-keyword">const</span> punycode = {
</pre>
        </td>
      </tr>
...
<span class="dox_type">trin</span>
        ...
        <td class="code highlight">
          <pre class="javascript">	<span class="hljs-string">'version'</span>: <span class="hljs-string">'2.3.1'</span>,
</pre>
        </td>
      </tr>
...
<span class="hljs-keyword">export</span> { ucs2decode, ucs2encode, decode, encode, toASCII, toUnicode };
<span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> punycode;
