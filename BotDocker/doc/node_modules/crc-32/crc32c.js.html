...
<html>
<head>
  <title>crc32c.js</title>
  <meta http-equiv="content-type" content="text/html; charset=UTF-8">
  <link rel="stylesheet" media="all" href="../../doc-style.css" />
  <script src="../../doc-filelist.js"></script>
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/crc-32/crc32c.js";
...
<div class="body">
        ...
        <td class="code highlight">
          <pre class="javascript"><span class="hljs-comment">/*exported CRC32C */</span>
<span class="hljs-keyword">var</span> CRC32C;
...
}(<span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">CRC32C</span>) </span>{
CRC32C.version = <span class="hljs-string">'1.2.2'</span>;
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">signed_crc_table</span>(<span class="hljs-params"></span>) </span>{
	...
	<span class="hljs-keyword">for</span>(<span class="hljs-keyword">var</span> n =<span class="hljs-number">0</span>; n != <span class="hljs-number">256</span>; ++n){
		c = n;
		c = ((c&amp;<span class="hljs-number">1</span>) ? (<span class="hljs-number">-2097792136</span> ^ (c &gt;&gt;&gt; <span class="hljs-number">1</span>)) : (c &gt;&gt;&gt; <span class="hljs-number">1</span>));
		c = ((c&amp;<span class="hljs-number">1</span>) ? (<span class="hljs-number">-2097792136</span> ^ (c &gt;&gt;&gt; <span class="hljs-number">1</span>)) : (c &gt;&gt;&gt; <span class="hljs-number">1</span>));
		c = ((c&amp;<span class="hljs-number">1</span>) ? (<span class="hljs-number">-2097792136</span> ^ (c &gt;&gt;&gt; <span class="hljs-number">1</span>)) : (c &gt;&gt;&gt; <span class="hljs-number">1</span>));
		c = ((c&amp;<span class="hljs-number">1</span>) ? (<span class="hljs-number">-2097792136</span> ^ (c &gt;&gt;&gt; <span class="hljs-number">1</span>)) : (c &gt;&gt;&gt; <span class="hljs-number">1</span>));
		c = ((c&amp;<span class="hljs-number">1</span>) ? (<span class="hljs-number">-2097792136</span> ^ (c &gt;&gt;&gt; <span class="hljs-number">1</span>)) : (c &gt;&gt;&gt; <span class="hljs-number">1</span>));
...
<p>$FlowIgnore</p>
        ...
        <td class="code highlight">
          <pre class="javascript">CRC32C.bstr = crc32_bstr;
</pre>
        </td>
      </tr>
...
<p>$FlowIgnore</p>
        ...
        <td class="code highlight">
          <pre class="javascript">CRC32C.buf = crc32_buf;
</pre>
        </td>
      </tr>
...
<p>$FlowIgnore</p>
        ...
        <td class="code highlight">
          <pre class="javascript">CRC32C.str = crc32_str;
}));
